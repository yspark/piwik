   ...
   _paq = _paq || [],
        ...
        function Tracker(trackerUrl, siteId) {
          ...
          function getImage(request) {
            ...
            console.log("image.src: %s", configTrackerUrl + "?" + request);
          }
          ...
          function sendRequest(request, delay) {
            console.log("function sendRequest()");
            var now = new Date();
          ...
          function logPageView(customTitle, customData) {
            console.log("function logPageView()");
            var now = new Date(),
            ...
            console.log("%d, %d, %d", configMinimumVisitTime, configHeartBeatTimer, !activityTrackingInstalled);
            ...
            console.log("end of logPageView()");
          }
...
trackLink: function (sourceUrl, linkType, customData) {
          ...
          trackPageView: function (customTitle, customData) {
            console.log("function trackPageView()");
                 ...
                 if (isInsightSession(configTrackerUrl, configTrackerSiteId)) {
                   ...
                   console.log("if 2: %s, %s", customTitle, customData);
                   trackCallback(function () {
